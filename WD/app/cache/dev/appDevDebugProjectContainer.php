...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'licencia', 'user' => 'ilb2', 'password' => 'dev', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_cdcaa0879883ae3fcfec72206336568a531063bdaea54aedc6c2fac88fb536dd');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/DsCorp/Equipo/EquipoBundle/Resources/views'), 'Equipo');
        $instance->addPath(($this->targetDirs[3].'/src/DsCorp/Empresa/EmpresaBundle/Resources/views'), 'Empresa');
        $instance->addPath(($this->targetDirs[3].'/src/DsCorp/General/GeneralBundle/Resources/views'), 'General');
        $instance->addPath(($this->targetDirs[3].'/src/DsCorp/Fabricante/FabricanteBundle/Resources/views'), 'Fabricante');
        $instance->addPath(($this->targetDirs[3].'/src/DsCorp/Cliente/ClienteBundle/Resources/views'), 'Cliente');
        $instance->addPath(($this->targetDirs[3].'/src/DsCorp/Personal/PersonalBundle/Resources/views'), 'Personal');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('563be5cfc826a8.35295905')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'EquipoBundle' => 'DsCorp\\Equipo\\EquipoBundle\\EquipoBundle',
                'EmpresaBundle' => 'DsCorp\\Empresa\\EmpresaBundle\\EmpresaBundle',
                'GeneralBundle' => 'DsCorp\\General\\GeneralBundle\\GeneralBundle',
                'FabricanteBundle' => 'DsCorp\\Fabricante\\FabricanteBundle\\FabricanteBundle',
                'ClienteBundle' => 'DsCorp\\Cliente\\ClienteBundle\\ClienteBundle',
                'PersonalBundle' => 'DsCorp\\Personal\\PersonalBundle\\PersonalBundle',
