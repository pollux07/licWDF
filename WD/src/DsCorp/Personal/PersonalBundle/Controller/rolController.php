...
use DsCorp\Personal\PersonalBundle\Entity\rol;
use DsCorp\Personal\PersonalBundle\Form\rolType;
...
class rolController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PersonalBundle:rol')->findAll();

        return $this->render('PersonalBundle:rol:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('PersonalBundle:rol:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PersonalBundle:rol')->find($id);
        ...
        return $this->render('PersonalBundle:rol:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('PersonalBundle:rol:edit.html.twig', array(
            'entity'      => $entity,
